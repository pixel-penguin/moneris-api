...
use PixelPenguin\Moneris\Crypt;
use PixelPenguin\Moneris\Receipt;
use PixelPenguin\Moneris\Moneris;
use PixelPenguin\Moneris\Response;
use PixelPenguin\Moneris\Processor;
use PixelPenguin\Moneris\Transaction;
...
class ResponseTest extends TestCase
{
     ...
     *
     * @var \PixelPenguin\Moneris\Processor
     */
    protected $processor;
     ...
     *
     * @var \PixelPenguin\Moneris\Response
     */
    protected $response;
    ...
    public function it_can_receive_a_receipt_from_a_properly_processed_transaction()
    {
        ...
        /** @var \PixelPenguin\Moneris\Response $response */
        $response = $response->validate();
